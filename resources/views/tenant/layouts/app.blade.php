...
<aside id="sidebar" class="sidebar flex flex-col h-full overflow-y-auto">
    ...
    <nav class="flex-1 px-3 py-4">
        ...
        @if (Route::has('absen-hp.show'))
        <a href="{{ route('absen-hp.show') }}" class="nav-item {{ request()->routeIs('absen-hp.show') ? 'active' : '' }}">
        ...
        @if ($role === 'tu' && Route::has('tu.siswa.index'))
        <a href="{{ route('tu.siswa.index') }}" class="nav-item {{ request()->routeIs('tu.siswa.*') ? 'active' : '' }}">
            <svg class="icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        @if ($role === 'kepsek' && Route::has('kepsek.absensi.index'))
        <a href="{{ route('kepsek.absensi.index') }}" class="nav-item {{ request()->routeIs('kepsek.absensi.*') ? 'active' : '' }}">
            <svg class="icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z"/>
            </svg>
            Monitoring Absensi
        ...
        @if (in_array($role, ['kepsek', 'tu']) && Route::has('absensi.devices.index'))
        <a href="{{ route('absensi.devices.index') }}" class="nav-item {{ request()->routeIs('absensi.devices.*') ? 'active' : '' }}">
            <svg class="icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        @if ($role === 'tu' && Route::has('tu.laporan.index'))
        <a href="{{ route('tu.laporan.index') }}" class="nav-item {{ request()->routeIs('tu.laporan.*') ? 'active' : '' }}">
            <svg class="icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
