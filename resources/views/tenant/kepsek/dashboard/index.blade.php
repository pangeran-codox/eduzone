...
<div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    --}}
        ...
        @if (Route::has('kepsek.absensi.index'))
        <a href="{{ route('kepsek.absensi.index') }}" class="t-card p-5 block hover:opacity-90 transition-opacity">
            <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-3" style="background: var(--t-green-bg);">
                <svg class="w-5 h-5" style="color: var(--t-green-tx);" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
