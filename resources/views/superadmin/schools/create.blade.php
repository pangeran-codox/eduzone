        ...
        <div>
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="principal_nip" value="{{ old('principal_nip') }}" class="form-input">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="bank_account_name" value="{{ old('bank_account_name') }}" class="form-input">
                </div>
            </div>
        </div>
